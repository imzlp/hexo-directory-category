    ...
    return Promise.all([
      ...
      if((data.external && data.external.length))
      {
        ...
        data.external.forEach(function(external_item){
          ...
          var author_github_id = external_item.github_id ? external_item.github_id : ''  
          var author_zhihu_addr = external_item.zhihu_addr ? external_item.zhihu_addr : ''  
          var author_email = external_item.email ? external_item.email : ''
          var author_wechat_image = external_item.wechat_image ? external_item.wechat_image : ''
          var author_avatar_image = external_item.avatar_image ? external_item.avatar_image : ''
