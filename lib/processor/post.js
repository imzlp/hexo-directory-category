    ...
    return Promise.all([
      ...
      if((data.external && data.external.length))
      {
        ...
        data.external.forEach(function(external_item){
          ...
          var external_post_id = getRndInteger(1000000000,2000000000);
          var append_item = ''
          var append_context = ''
          if(site_config.hexo_external_post && site_config.hexo_external_post.enable)
          {
            ...
            external_post_id = getRndInteger(site_config.hexo_external_post.min_post_id,site_config.hexo_external_post.min_post_id);
