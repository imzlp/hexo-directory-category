    ...
    return Promise.all([
      ...
      if((data.external && data.external.length))
      {
        ...
        data.external.forEach(function(external_item){
          ...
          var author_name = external_item.author_name ? external_item.author_name : ''  
          var author_site = external_item.author_site ? external_item.author_site : ''  
          var author_github_id = external_item.author_github_id ? external_item.author_github_id : ''  
          var author_zhihu_addr = external_item.author_zhihu_addr ? external_item.author_zhihu_addr : ''  
          var author_email = external_item.author_email ? external_item.author_email : ''
          var author_wechat_image = external_item.author_wechat_image ? external_item.author_wechat_image : ''
          var author_avatar_image = external_item.author_avatar_image ? external_item.author_avatar_image : ''
